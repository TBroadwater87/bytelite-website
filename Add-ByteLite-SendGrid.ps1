...
Write-Host ''
Write-Host 'Then verify against the canonical production domain. This probe sends nothing:'
Write-Host '    Invoke-WebRequest -Uri "https://www.thebytelite.com/api/contact" -Method GET -SkipHttpErrorCheck'
Write-Host ''
Write-Host 'Expect 405 with Allow: POST. A 503 from a real POST means a variable is missing.'
Write-Host 'See OWNER_README.md section 8 for the full 405 / 400 / 202 contact-route verification.'
Write-Host ''
