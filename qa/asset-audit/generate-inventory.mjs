...
const INSPECTED = {
  'Deck_Initiate_2.5_3.5.png': { subject: 'Gold infinity-heart mark on pale pink, labeled "Initiate"', decision: 'selected', role: 'Cordel Play tier card', dest: 'public/cordel/tiers/cordel-play-tier-card-initiate-product.webp' },
  'Deck_Connect_2.5_3.5.png': { subject: 'Gold infinity-heart mark on rose pink, labeled "Connect"', decision: 'selected', role: 'Cordel Play tier card', dest: 'public/cordel/tiers/cordel-play-tier-card-connect-product.webp' },
  'Deck_Seduce_2.5_3.5.png': { subject: 'Gold infinity-heart mark on magenta, labeled "Seduce"', decision: 'selected', role: 'Cordel Play tier card', dest: 'public/cordel/tiers/cordel-play-tier-card-seduce-product.webp' },
  'Deck_Stimulate_2.5_3.5.png': { subject: 'Gold infinity-heart mark on amber orange, labeled "Stimulate"', decision: 'selected', role: 'Cordel Play tier card', dest: 'public/cordel/tiers/cordel-play-tier-card-stimulate-product.webp' },
  'Deck_Edge_2.5_3.5.png': { subject: 'Gold infinity-heart mark on deep red, labeled "Edge"', decision: 'selected', role: 'Cordel Play tier card', dest: 'public/cordel/tiers/cordel-play-tier-card-edge-product.webp' },
  'Deck_Climax_2.5_3.5.png': { subject: 'Gold infinity-heart mark on dark crimson, labeled "Climax"', decision: 'selected', role: 'Cordel Play tier card', dest: 'public/cordel/tiers/cordel-play-tier-card-climax-product.webp' },
  ...
  '01_HeartStrings_Boardgame\\Mockups\\HeartStrings_Hosts_Gameplay_Sorted\\02_PICK_Host_AIon_Solo.png': { subject: 'Photoreal man in vest/headset holding a red die, warm lounge setting', decision: 'inspected-not-newly-used', reason: 'Tasteful, on-brand, but already present in repo as public/cordel/cordel-aion-icon.png-equivalent context from a prior session pass; not re-copied.' },
  '01_HeartStrings_Boardgame\\Mockups\\zip_extracted\\AIya_AIon_Heartstrings_Banner.png': { subject: 'Stylized paired AIya + AIon illustration, "Your Trusted AI Connection Guides" tagline', decision: 'already-in-repo', reason: 'Byte-identical to public/cordel/cordel-guides-banner.png (confirmed matching file size), imported in an earlier session pass. Reused via existing repo path on the homepage, Deep Kore/AIya hero, and Restaurant Partner Program hero this pass; not re-copied.' },
  'HeartStrings_Play_20x20_Final.png': { subject: 'Full gameflow poster: board, 6 tier cards, Decree card, both host photos', decision: 'already-in-repo', reason: 'Matches public/cordel/gameflow.jpg from a prior session pass ("single gameflow poster" commit). Not re-copied.' },
  ...
  'Screenshot_20260725_082752_HeartStrings.jpg': { subject: 'Real mobile screenshot of the private-test Cordel Connect app (captured under the app\'s prior HeartStrings name, screen content not retouched): AIya companion screen, "Good morning, Tash", daily horoscope card, nav', decision: 'selected', role: 'Real app-evidence screenshot', dest: 'public/cordel-connect/cordel-connect-app-companion-screen-evidence.webp' },
  ...
  'Cordel_Logo.png': { subject: 'Glowing pink/rainbow infinity-heart mark with script "Cordel" wordmark on black', decision: 'selected', role: 'Cordel logo mark - fallback image for 4 product-page slots pending real product photography (20x20 board, Ultimate board, Consent Cup, gameflow diagram)', dest: 'public/cordel/cordel-logo-mark.png' },
};
const ICON_SUBSET = [
...
for (const icon of ICON_SUBSET) {
  INSPECTED[`02_HeartStrings_App_and_Wingman\\App_Icons\\heartstrings_ui_pack\\heartstrings_ui_pack\\svg\\filled\\${icon}.svg`] = {
    ...
    decision: 'selected',
    role: 'Cordel Connect feature icon',
    dest: `public/cordel-connect/icons/${icon}.svg`,
  };
}
