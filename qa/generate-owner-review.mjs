...
const ROUTE_META = [
  ...
  ['/products/cordel-play', 'cordel-play-overview', 'Cordel Play Overview', 'Cordel Play', 'public'],
  ['/products/cordel-play/how-it-plays', 'cordel-play-how-it-plays', 'How It Plays', 'Cordel Play', 'nested'],
  ['/products/cordel-play/editions', 'cordel-play-editions', 'Editions', 'Cordel Play', 'nested'],
  ['/products/cordel-play/components', 'cordel-play-components', 'Components', 'Cordel Play', 'nested'],
  ['/products/cordel-play/consent-architecture', 'cordel-play-consent', 'Consent Architecture', 'Cordel Play', 'nested'],
  ['/products/cordel-play/development-status', 'cordel-play-dev-status', 'Development Status', 'Cordel Play', 'nested'],
  ['/products/cordel-play/preorder', 'cordel-play-preorder', 'Cordel Play Preorder', 'Cordel Play', 'preorder'],
  ['/products/cordel-connect', 'cordel-connect-overview', 'Cordel Connect Overview', 'Cordel Connect', 'public'],
  ['/products/cordel-connect/compatibility-and-matching', 'cordel-connect-compatibility', 'Compatibility and Matching', 'Cordel Connect', 'nested'],
  ['/products/cordel-connect/privacy-architecture', 'cordel-connect-privacy', 'Privacy Architecture', 'Cordel Connect', 'nested'],
  ['/products/cordel-connect/safety', 'cordel-connect-safety', 'Safety', 'Cordel Connect', 'nested'],
  ['/products/cordel-connect/games-and-shared-activities', 'cordel-connect-games', 'Games and Shared Activities', 'Cordel Connect', 'nested'],
  ['/products/cordel-connect/date-planning', 'cordel-connect-date-planning', 'Date Planning', 'Cordel Connect', 'nested'],
  ['/products/cordel-connect/cartoonized-profiles', 'cordel-connect-cartoonized', 'Cartoonized Profiles', 'Cartoonized Profiles', 'nested'],
  ['/products/cordel-connect/aiya-and-aion', 'cordel-connect-aiya-aion', 'AIya and Aion', 'AIya and Aion', 'nested'],
  ['/products/cordel-connect/byteoracle-horoscopes', 'cordel-connect-byteoracle', 'ByteOracle Horoscopes', 'ByteOracle Horoscopes', 'nested'],
  ['/products/cordel-connect/date-planning/blind-date-roulette', 'cordel-connect-blind-date', 'Blind Date Roulette', 'Blind Date Roulette', 'nested'],
  ['/products/cordel-connect/date-planning/restaurants', 'cordel-connect-restaurants', 'Restaurants', 'Restaurants', 'nested'],
  ['/products/cordel-connect/date-planning/restaurants/partner-program', 'cordel-connect-partner-program', 'Restaurant Partner Program', 'Restaurant Partner Program', 'partner'],
...
const SECTION_ORDER = [
  ...
  'Genesis Goalkeeper', 'ByteOracle', 'ByteFlow', 'ByteCost', 'Cordel Play',
  'Cordel Connect', 'Cartoonized Profiles', 'AIya and Aion', 'ByteOracle Horoscopes',
...
const ROUTE_CANONICAL_STATUS = {
  ...
  '/products/cordel-play': 'Prototype',
  '/products/cordel-play/how-it-plays': 'Prototype',
  '/products/cordel-play/editions': 'Prototype',
  '/products/cordel-play/components': 'Prototype',
  '/products/cordel-play/consent-architecture': 'Prototype',
  '/products/cordel-play/development-status': 'Prototype',
  '/products/cordel-play/preorder': 'Prototype',
  '/products/cordel-connect': 'Private Test',
  '/products/cordel-connect/compatibility-and-matching': 'Private Test',
  '/products/cordel-connect/privacy-architecture': 'Private Test',
  '/products/cordel-connect/safety': 'Private Test',
  '/products/cordel-connect/cartoonized-profiles': 'Private Test',
  '/products/cordel-connect/aiya-and-aion': 'Private Test',
  '/products/cordel-connect/games-and-shared-activities': 'Private Test',
  '/products/cordel-connect/byteoracle-horoscopes': 'Private Test',
  '/products/cordel-connect/date-planning': 'Private Test',
  '/products/cordel-connect/date-planning/blind-date-roulette': 'Private Test',
  '/products/cordel-connect/date-planning/restaurants': 'Private Test',
  // Restaurant Partner Program has its own, more specific canonical record that overrides
  // the parent Cordel Connect status for this exact route.
  '/products/cordel-connect/date-planning/restaurants/partner-program': 'Public Beta',
};
