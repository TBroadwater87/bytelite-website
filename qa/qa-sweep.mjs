...
const ROUTES = [
  ...
  ['/products/cordel-play', 'cordel-play-overview'],
  ['/products/cordel-play/how-it-plays', 'cordel-play-how-it-plays'],
  ['/products/cordel-play/editions', 'cordel-play-editions'],
  ['/products/cordel-play/components', 'cordel-play-components'],
  ['/products/cordel-play/consent-architecture', 'cordel-play-consent'],
  ['/products/cordel-play/development-status', 'cordel-play-dev-status'],
  ['/products/cordel-play/preorder', 'cordel-play-preorder'],
  ['/products/cordel-connect', 'cordel-connect-overview'],
  ['/products/cordel-connect/compatibility-and-matching', 'cordel-connect-compatibility'],
  ['/products/cordel-connect/privacy-architecture', 'cordel-connect-privacy'],
  ['/products/cordel-connect/safety', 'cordel-connect-safety'],
  ['/products/cordel-connect/cartoonized-profiles', 'cordel-connect-cartoonized'],
  ['/products/cordel-connect/aiya-and-aion', 'cordel-connect-aiya-aion'],
  ['/products/cordel-connect/games-and-shared-activities', 'cordel-connect-games'],
  ['/products/cordel-connect/byteoracle-horoscopes', 'cordel-connect-byteoracle'],
  ['/products/cordel-connect/date-planning', 'cordel-connect-date-planning'],
  ['/products/cordel-connect/date-planning/blind-date-roulette', 'cordel-connect-blind-date'],
  ['/products/cordel-connect/date-planning/restaurants', 'cordel-connect-restaurants'],
  ['/products/cordel-connect/date-planning/restaurants/partner-program', 'cordel-connect-partner-program'],
  ['/progress', 'progress'],
